...
import img23 from "/src/assets/img23.jpeg";
import img from "/src/assets/img.jpeg";
import img52 from "/src/assets/img52.jpeg";
import img53 from "/src/assets/img53.jpeg";
import img57 from "/src/assets/img57.jpeg";
import img55 from "/src/assets/img55.jpeg";
import img56 from "/src/assets/img56.jpeg";

function Quality() {
  return (
    <>
      <h1 className=" text-center text-[30px] font-semibold m-[26px]">
        Quality{" "}
        <span className=" rounded-lg text-[30px] bg-slate-600 text-white p-[10px] ">
          Wears
        </span>
      </h1>
      <div className=" flex-col max-md:h-[1220vh] max-md:flex-col flex items-center justify-center h-[415vh] ">
        <div className=" flex max-md:flex-col ">
          ...
          <div className=" flex-col items-center justify-center m-[10px] ">
            ...
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
                <b className="  ">$ 40.99</b>
              </span>
              <button>
                <img
          ...
          <div className=" flex-col items-center justify-center m-[10px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Browm Polo </h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[20px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Skyblue T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex">
                <b className=" line-through ">$ 88.99</b>
        ...
        <div className=" flex max-md:flex-col ">
          <div className=" flex-col items-center justify-center m-[10px] ">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Brown Polo And Joggers</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[10px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Brown Vintage Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[20px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Black T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
        ...
        <div className=" flex max-md:flex-col ">
          <div className=" flex-col items-center justify-center m-[10px] ">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Polo Pairs</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
          ...
          <div className=" flex-col items-center justify-center m-[10px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Aesthetic T-shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[20px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 30.99</b>
                <b className="  ">$ 60.99</b>
              </span>
              <button>
                <img
        ...
        <div className=" flex max-md:flex-col ">
          <div className=" flex-col items-center justify-center m-[10px] ">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Brown T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className=" gap-4 flex ">
                <b className=" line-through ">$ 20.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[10px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Olive Green T-shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
          ...
          <div className=" flex-col items-center justify-center m-[20px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Orange Shirt and Short</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className="gap-4 flex ">
        ...
        <div className=" flex max-md:flex-col ">
          <div className=" flex-col items-center justify-center m-[10px] ">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Vintage T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className="gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[10px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Colourful Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className="gap-4 flex ">
                <b className=" line-through ">$ 88.99</b>
          ...
          <div className=" flex-col items-center justify-center m-[20px]">
            ...
            />
            <div className=" ">
              <h2 className=" m-[13px] ">Dark Olive Green T-Shirt</h2>
            </div>
            <span className="flex m-[20px] items-center justify-between">
              <span className="gap-4 flex ">
                <b className=" line-through ">$ 30.99</b>
