...
function Aesthetic() {
  return (
    <>
      <div className=" mt-[150px] max-md:h-[100vh] max-md:flex-col  m-0 flex items-center justify-center ">
        <div className=" flex justify-center items-center bg-cover bg-top bg-no-repeat bg-[url(/src/assets/img41.jpeg)] h-[30vh] w-[100%] ">
          <div className="">
